...
- I haven't included download scripts, but it is the same as the original one. You can use that for now. The model needs `hourly_electricity.csv`, `formatted_omi_vol.csv` etc.
